process SNIPPY_MAP {
    tag "running snippy map"
    publishDir "${params.outdir}/snippy_out_map", mode: 'symlink'
    ...
    prefix = task.ext.prefix ?: "snippy-map"
